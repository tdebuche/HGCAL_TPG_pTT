...
parser.add_argument("Board", help="Board to display",type=int)
parser.add_argument("--SizeX",default = 34, help="figure size",type =int)
parser.add_argument("--SizeY",default = 16, help="figure size",type = int)
args = parser.parse_args()
Board = args.Board
xsize,ysize = args.SizeX,args.SizeY
